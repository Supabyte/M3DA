...
int main(int argc, char **argv) {
    ...
    std::cout << "Right epipolars" << std::endl;
    std::cout << mRightEpipolarLines << std::endl;
    std::cout << "--------------------------------------" << std::endl;
    ...
    std::cout << mLeftCorners.t() << std::endl;
    std::cout << "--------------------------------------" << std::endl;
    std::cout << "Right corners" << std::endl;
    std::cout << mRightCorners.t() << std::endl;
    std::cout << "--------------------------------------" << std::endl;
    ...
    if (mLeftCorners.cols * mRightCorners.cols) {
        ...
        for(int i = 0; i < mDistances.cols; i++){
            int8_t related = mRightHomologous.at<int8_t>(i);
            if(related != -1){
                std::cout << mLeftCorners.col(i) << " --> " << mRightCorners.col(related) << std::endl;
            } else {
                std::cout << mLeftCorners.col(i) << " --> " << "None" << std::endl;
            }
            //std::cout <<  << std::endl;
        }
    }
